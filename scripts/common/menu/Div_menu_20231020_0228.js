function Div_menu() {
	function Div_menu_text(props) {
		return (
			<a href={props.url} class="flex justify-center items-center w-[120px] h-[17px] px-[12px] py-[25px] 
		...
		return (
			<div class="flex justify-between items-center h-[36px]">
				...
				<div id="menu_name" class="flex justify-center items-center md:hidden">
					...
					<Div_menu_text text={"포트폴리오"} url={"/portfolio/"} />
					<Div_menu_text text={"팀업"} url={"/teamup/"} />
				...
				<div id="menu_right" class="flex justify-center items-center space-x-[10px] md:hidden">
					...
					<span class="hidden" id="btn_alert_opened"
							onClick={() => menu('alert')}>
						<img src="https://cdn.jsdelivr.net/gh/Ignite-Official/CDN/web/image/menu/menu_cancel.svg" class="w-[12px] h-[12px]" />
					</span>
				...
				<div class="items-center justify-center hidden md:flex md:visible">
					...
					<button type="button" id="btn_menu_opened" onClick={() => menu('hamburger')}
							class="hidden">
							<img src="https://cdn.jsdelivr.net/gh/statground/wonyframe_CDN/image/menu/menu_cancel.svg" class="w-[24px] h-[24px]" />
					</button>
	...
	function Div_menu_mobile() {
		return (
			<div id="div_menu_mobile" class="hidden">
				...
				<div class="grid grid-cols-4 sm:grid-cols-3">
				...
				<ul class="flex-row text-[14px] font-[600]">
					<Div_menu_text_mobile text={"포트폴리오"} url={"/portfolio/"} />
					<Div_menu_text_mobile text={"팀업"} url={"/teamup/"} />
