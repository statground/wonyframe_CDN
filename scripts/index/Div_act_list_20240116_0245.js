	...
	const btn_List = Object.keys(props.data).map((btn_data) =>
		<button type="button"
				class="w-fit min-w-[32px] max-w-[216px] px-[8px] h-[22px] 
					   flex justify-center items-center border-gray-100 bg-white rounded-md border border-gray-900
					   hover:bg-blue-100 hover:text-blue-700 focus:outline-none focus:z-10 focus:ring-4">
