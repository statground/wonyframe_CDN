function Div_main_skeleton_card_list(props) {
	...
	return (
		<div class={"grid grid-cols-" + props.cols + " justify-center items-center w-full gap-[12px] animate-pulse md:grid-cols-1"}>
