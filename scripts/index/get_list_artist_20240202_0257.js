	...
	function Div_artist_card_list(props) {
		...
		return (
			<div class="flex flex-col w-full h-fit" id="div_artist_sub">
				<div class="flex flex-nowrap justify-start items-start space-x-[12px] overflow-x-scroll scroll-smooth scroll-hide" id="div_artist_slider">
					{artist_List}
					<div id="div_artist_prev"
						class="absolute top-[675px] left-[68px] z-10 sm:top-[675px] sm:left-[-5px] cursor-pointer
					...
					<div id="div_artist_next"
						class="absolute top-[675px] right-[82px] z-10 sm:top-[675px] sm:right-[5px] cursor-pointer
								hover:rounded-full hover:text-blue-700 focus:z-10 focus:ring-8 focus:ring-gray-200">
