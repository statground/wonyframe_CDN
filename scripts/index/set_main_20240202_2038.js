function set_main() {    
	function Div_banner_top(props) {
		...
		return (
			<div class="flex flex-betweeen bg-gray-200 w-full max-w-screen">
				<div class="grid grid-cols-3 justify-between items-center text-start w-full h-[400px]
							sm:h-[180px] bg-white border-b-2 border-gray-100"
					onClick={props.function}>
					<div class="flex flex-col col-span-2 w-full justify-start items-start px-[80px]
								md:px-[40px] sm:px-[12px]">
	...
	function Div_main() {
		return (
			<div class="flex flex-col w-full space-y-[40px]">
				...
				<div class="grid grid-cols-2 justify-center items-start md:flex md:flex-col md:space-y-[40px]">
